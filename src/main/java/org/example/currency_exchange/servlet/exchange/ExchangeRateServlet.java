...
public class ExchangeRateServlet extends HttpServlet {
    ...
    private void addCurrencyCodesInParameters(String baseCurrencyCode, String targetCurrencyCode, Map<String, String> parameters) {
        parameters.put("baseCurrencyCode", baseCurrencyCode);
        parameters.put("targetCurrencyCode", targetCurrencyCode);
    }
}
